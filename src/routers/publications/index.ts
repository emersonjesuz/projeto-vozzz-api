...
publicationsRouter.post(
  "/publications",
  new CreatePublicationController().createPublication
);
publicationsRouter.get(
  "/publications/:id",
  new GetPublicationController().getPublication
);
publicationsRouter.put(
  "/publications/:id",
  new EditPublicationController().getPublication
);
publicationsRouter.delete(
  "/publications/:id",
  new DeletePublicationController().getPublication
);
